        ...
        <div class="about-card">
          ...
          <section class="about-section">
            ...
            <div class="section-body">
              <p>
                你好，我是
                <strong>wutao</strong>，一名喜欢折腾代码的普通计科学生。
              </p>
              <p>
                安阳工学院 软件工程 23
                级在读，主要兴趣和精力都投在了探索Agent的方方面面。
              </p>
            </div>
          </section>
          ...
          <section class="about-section">
            ...
            <div class="section-body">
              ...
              <p>
                如果你仔细看看，会发现这里除了技术分享，还有不少我的日常琐碎和内心所想，记录这些才是我建立这里的根本原因。
              </p>
              <p>
          ...
          <section class="about-section">
            ...
            <div class="contact-list">
              <div class="contact-item">
                ...
                <span class="contact-value">2721386276</span>
              </div>
